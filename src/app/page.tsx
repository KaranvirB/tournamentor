    ...
    return (
        <Layout>
            ...
            <div className="flex flex-col bg-gradient-to-b from-blue-950/75 to-black border-b-4 border-purple-400 py-10 rounded-t-[3rem] space-y-10">
                <div className="border border-purple-400 p-8 rounded-full mx-auto">
                ...
                <div className="flex flex-row p-8 columns-4 space-x-5">
                    <div className="w-[30%] text-lg text-purple-300 p-6 border border-purple-400 rounded-[2rem] mx-auto">
                        <p>
                    ...
                    <div className="w-[30%] text-lg text-purple-300 p-6 h-[20rem] border border-purple-400 rounded-[2rem] mx-auto">
                        <p>
